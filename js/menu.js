    ...
    initializeGameConfigs() {
        return {
            ...
            minecraft: {
                ...
                controls: 'WASD: Move | Mouse: Look around | Left Click: Break | Right Click: Place | Space: Jump',
                icon: '🟫',
                botCount: 0,
                difficulty: 0.8,
                gameMode: 'minecraft',
            ...
            roblox: {
                ...
                controls: 'WASD: Move | Mouse: Look around | Space: Jump | Click: Interact',
                icon: '🎮',
                botCount: 3,
                difficulty: 0.8,
                gameMode: 'roblox',
            ...
            citybuilder: {
                ...
                controls: 'Mouse: Select and place | WASD: Pan camera | Scroll: Zoom',
                icon: '🏙️',
                botCount: 0,
                difficulty: 0.7,
